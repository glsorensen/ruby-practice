...
RSpec.describe 'Arrays' do
  ...
  it 'test 10' do
    ...
    fourteeners = fourteeners.reject { |x| x.nil? }
     
    fourteeners = fourteeners.each do |x|
      x.nil? ? fourteeners.delete(x) : x
     end
    
    new = []

    fourteeners = fourteeners.each do |x|
      x.nil? == false ? new.push(x) : x
     end
    ...
    fourteeners = fourteeners.reject do |x|
      x.nil?
    end
    
    # fourteeners = fourteeners - [nil]
